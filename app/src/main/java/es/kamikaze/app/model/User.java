...
public class User {
    ...
    public User() {
        ...
        //generar nombre de usuario ramdom, hay poca posibilidad de que se repitan nombres pero deberiamos comprobar que no hay nadie con el mimsmo nombre antes de asignarlo
